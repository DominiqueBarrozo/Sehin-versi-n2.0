...
namespace Sehin_versión2._0.Controllers
{
    public class ContactoesController : Controller
    {
        ...
        {
            var contactoSet = db.ContactoSet.Include(c => c.Localidades);
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,TipoDoc,NumeroDoc,Email,Telefono,Domicilio,Foto,LocalidadesId")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,TipoDoc,NumeroDoc,Email,Telefono,Domicilio,Foto,LocalidadesId")] Contacto contacto)
        {
            if (ModelState.IsValid)
            {
